...
# 29. Additional Renderer Fixtures

The sections above exercise most of the supported syntax. The fixtures below
cover the remainder, so this file alone is enough to check a renderer.

## Emphasis edge cases

Nested formatting: **bold containing *italic* and `code`**.

Underscores: _emphasis_, __strong emphasis__, and snake_case_identifiers that
must stay intact.

Escaped markers keep their punctuation: \*not emphasis\*, \_not emphasis\_,
\`not code\`, and a literal backslash \\.

## Links and images

An inline [link with a title](https://www.chromium.org/ "Chromium project"),
a [relative link](./README.md), a [fragment link](#29-additional-renderer-fixtures),
and a [mail link](mailto:nobody@example.com).

An image with alt text: ![Placeholder icon](./icons/icon-192.png)

Unsafe destinations must render as plain text rather than as live links:

[this must not be clickable](javascript:alert&#40;1&#41;)
...
- [x] Render **bold** inside a task item
- [ ] Render `code` inside a task item

## Blockquote containing other blocks

> ### Quoted heading
>
> A quoted paragraph with a [link](https://www.chromium.org/).
>
> ```text
> quoted code block
> ```
...
| :--- | :----: | ----: |
| a | b | 1 |
| longer cell | centred | 22 |
| `code` | **bold** | 333 |

## Long content

A very long URL that must not push the page sideways:
<https://example.com/a/very/long/path/that/keeps/going/and/going/and/going/for/quite/a/while>

```text
A deliberately long code line: ....................................................................................................
```

## Characters that must survive

Ampersand & less-than < greater-than > quote " apostrophe ' backtick `
pipe \| tilde ~ caret ^ and an emoji 📄.
